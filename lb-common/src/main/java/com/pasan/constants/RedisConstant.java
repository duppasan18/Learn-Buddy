...
public class RedisConstant {
    public static final String USER_LOCATION_KEY = "user:location"; // 用户位置
    public static final String NEARBY_MEMBER_PREFIX = "user:";  // 用户前缀
    public static final String TOKEN_KEY = "user:token:" ; // token前缀
    ...
    public static final String ROOM_INFO_KEY = "room:info"; // 自习室信息

    public static final String INVITATION_COUNT_KEY = "invite:count:"; // 邀约当前人数
